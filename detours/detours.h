...
extern ULONG DETOUR_REGION_SIGNATURE;
extern ULONG DETOUR_REGION_SIZE;
extern ULONG DETOUR_TRAMPOLINES_PER_REGION;
extern PDETOUR_REGION s_pRegions;			// List of all regions.
extern PDETOUR_REGION s_pRegion;			// Default region.
