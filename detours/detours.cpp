...
//
ULONG DETOUR_REGION_SIGNATURE = 0;
ULONG DETOUR_REGION_SIZE = 0x10000;
ULONG DETOUR_TRAMPOLINES_PER_REGION = (DETOUR_REGION_SIZE
                                             / sizeof(DETOUR_TRAMPOLINE)) - 1;
PDETOUR_REGION s_pRegions = NULL;            // List of all regions.
PDETOUR_REGION s_pRegion = NULL;             // Default region.
